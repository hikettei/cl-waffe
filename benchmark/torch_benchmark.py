...
RESULT_DIR = './benchmark/results/torch_result.json'
RESULTS = []

# Files
MATMUL_RESULT_DIR = './benchmark/results/matmul_torch.png'
BROADCASTING_RESULT_DIR = './benchmark/results/broadcasting_torch.png'
SLICING_RESULT_DIR = './benchmark/results/slicing_torch.png'
NN_RESULT_DIR = './benchmark/results/dense_torch.png'
...
def main():
    ...
    RESULTS = [{"backend":f"torch version: {torch.__version__}, works on {BACKEND_NAME}"},
